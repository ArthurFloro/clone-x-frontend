...
export const SignupForm = () => {
  ...
  const [nameField, setNameField] = useState(""); // para salvar o que o usuário digita
  const [emailField, setEmailField] = useState(""); // para salvar o que o usuário digita no email
